...
export const DOMAIN_REGISTRY = Object.freeze({
  core: Object.freeze({
    ...
    navLabel: "Unified",
    displayName: "Unified",
    title: "Unified environmental program",
    status: "Unified workspace",
  ...
  heat: Object.freeze({
    ...
    navLabel: "Heat",
    displayName: "Heat",
    title: "Heat monitoring model",
    status: "Heat workspace",
  ...
  air: Object.freeze({
    ...
    navLabel: "Air",
    displayName: "Air",
    title: "Air monitoring model",
    status: "Air workspace",
  ...
  soil: Object.freeze({
    ...
    navLabel: "Soil",
    displayName: "Soil",
    title: "Soil monitoring model",
    status: "Soil workspace",
  ...
  water: Object.freeze({
    ...
    navLabel: "Water",
    displayName: "Water",
    title: "Water monitoring model",
    status: "Water workspace",
